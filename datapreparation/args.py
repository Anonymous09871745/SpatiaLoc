...
def parse_arguments():
    parser = argparse.ArgumentParser(description="K360 data preparation, we also provide a link to the processed dataset.")

    parser.add_argument("--path_in", type=str, default="./data/kitti360")
    parser.add_argument("--path_out", type=str, default="./data/KITTI360Pose/k360")
